...
class FAQaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.addAll(
                listOf(
                        "Q1. What is COEXCL all about?",
                        "Q2. How should I join COEXCL's 24X7 online tutor facility?",
                        "Q3. What type of queries can the COEXCL Tutor solve?? ",
                        ...
                        "Q12. Till what class will I get teacher support from COEXCL?",
                        ...
                        "Q23. Is my Profile data is safe with COEXCL?"
        ...
        listAnswer.addAll(
                listOf(
                        "Ans: COEXCL means to connect experts with classes. Coexcl provides learning application with one of a kind facilities for schools as well as students. We have a really good team in academics which is responsible for solving academic queries of the students and providing good solution to their doubts. Apart from this, the COEXCL platform also provides many additional features such as study material and virtual schooling, all in one place.",
                        ...
                        "Ans: All services, including COEXCL's 24x7 tutor facility, are free until Covid Pandemic ends. However the premium charges are very nominal, and anyone can easily afford such service. For more package details you can visit our website www.coexcl.com.",
                        "Ans: Make notes is a unique features of COEXCL where you can make notes whatever you want related to your studies, and then you can save it also for future reference.",
                        "Ans: Fun Facts is another unique features of COEXCL in which you can explore things beyond your books. You will get updates on Fun Facts every week.",
                        "Ans: School Activity is the list of Notifications which your school has sent for you only. It is a very specific feature and is controlled by your school admin and is directly connected from your school updates. Please note to enjoy this feature, your school should have to be active admin member of COEXCL.",
                        ...
                        "Ans: Well, COEXCL brings you the best of the category video from youtube gallery after applying several quality check Filters. \n" +
                                "\n" +
                                "Note: COEXCL doesn't claims its Propriotory over the Videos as its meant only for education  purpose and is absolutely. Free.",
                        "Ans: Absolutely Yes. COEXCL never user your data for any kind of marketing or assessments. Nor your data is reveled anywhere. For details you can see our users Terms and Policy."
